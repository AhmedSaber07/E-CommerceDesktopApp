...
namespace E_Commerce.Presentation
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			HomePage.Size = new Size(707, 476);
			HomePage.TabIndex = 1;
			HomePage.Text = "Home";
			...
			CategoriesPage.Size = new Size(707, 476);
			...
			ProductsPage.Size = new Size(707, 476);
			...
			buttonAddProduct.Location = new Point(34, 417);
			buttonAddProduct.Margin = new Padding(3, 2, 3, 2);
			buttonAddProduct.Name = "buttonAddProduct";
			buttonAddProduct.Size = new Size(140, 41);
			...
			flowLayoutPanel1.Location = new Point(13, 50);
			flowLayoutPanel1.Margin = new Padding(3, 2, 3, 2);
			flowLayoutPanel1.Name = "flowLayoutPanel1";
			flowLayoutPanel1.Size = new Size(681, 344);
			...
			OrdersPage.Size = new Size(707, 476);
			...
			dgrViewOrders.Columns.AddRange(new DataGridViewColumn[] { OName, FinalPrice, Date, Email });
			dgrViewOrders.Dock = DockStyle.Fill;
			dgrViewOrders.Location = new Point(3, 3);
			dgrViewOrders.Name = "dgrViewOrders";
			dgrViewOrders.RowHeadersWidth = 51;
			dgrViewOrders.RowTemplate.Height = 25;
			dgrViewOrders.Size = new Size(701, 470);
			dgrViewOrders.TabIndex = 0;
			// 
			// OName
			// 
			OName.DataPropertyName = "FullName";
			OName.HeaderText = "Full Name";
			OName.MinimumWidth = 10;
			OName.Name = "OName";
			// 
			// FinalPrice
			// 
			...
			AddAdminPage.Size = new Size(707, 476);
